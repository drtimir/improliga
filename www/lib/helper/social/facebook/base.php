...
namespace Helper\Social\Facebook
{
	/**
	...
	abstract class Base
	{
		...
		protected function getUserFromAccessToken()
		{
			try {
				...
				return $user_info['id'];
			} catch (HelperSocialFacebookApiException $e) {
				return 0;
			}
		}
		 ...
		 * @throws HelperSocialFacebookApiException
		 */
		protected function _restserver($params)
		{
			...
			if (is_array($result) && isset($result['error_code'])) {
				throw new HelperSocialFacebookApiException($result);
			}
		...
		protected function makeRequest($url, $params, $ch=null)
		{
			...
			if ($result === false) {
				$e = new HelperSocialFacebookApiException(array(
		...
		{
			$e = new HelperSocialFacebookApiException($result);
			switch ($e->getType()) {
